...
//    glCullFace(GL_BACK);
    ...
    std::string blur_vsh_path = file_path + "gaussian_blur.vsh",
                blur_fsh_path = file_path + "gaussian_blur.fsh";
